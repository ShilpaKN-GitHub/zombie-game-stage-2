...
function setup()
{
  createCanvas(displayWidth + 1000, 700);
  ...
  armor = createSprite(displayWidth/2 + 500, 550, 20, 20);
...
function draw()
{
  ...
  if(gameState === "INSTRUCTIONS")
  {
    ...
    text("TIP : Aim at the Zombie's head." , displayWidth/2, 125);
    text("Press UP ARROW to start." , displayWidth/2, 175);
